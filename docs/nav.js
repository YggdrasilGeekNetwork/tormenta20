...
function buildNav(container, activeSrc) {
  ...
  function modelLinks(prefix, open) {
    ...
    return `<details ${open}><summary class="nav-section-toggle">${label}<span class="badge ${cls}">${tag}</span></summary>${links}</details>`
  }
  ...
  container.innerHTML = `
    ...
    <a href="typedoc/">TypeDoc (TS/JS) <span class="badge badge-ts">TS</span></a>
    <a href="https://rubydoc.info/gems/tormenta20">RubyDoc <span class="badge badge-rb">RB</span></a>
    ...
    <a href="https://www.npmjs.com/package/tormenta20">npm <span class="badge badge-ext">↗</span></a>
    <a href="https://rubygems.org/gems/tormenta20">RubyGems <span class="badge badge-ext">↗</span></a>
    <span class="sidebar-section">Projeto</span>
    <a href="https://github.com/YggdrasilGeekNetwork/tormenta20">GitHub <span class="badge badge-ext">↗</span></a>
    <a href="https://github.com/YggdrasilGeekNetwork/tormenta20/issues">Issues <span class="badge badge-ext">↗</span></a>
  `
}
